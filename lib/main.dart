// ignore_for_file: public_member_api_docs, avoid_print, use_build_context_synchronously, unnecessary_null_comparison, unused_local_variable, prefer_const_literals_to_create_immutables
...
import 'package:kemrea_webview/constants.dart';
import 'package:path_provider/path_provider.dart';
import 'package:webview_flutter/webview_flutter.dart';

void main() => runApp(
    const MaterialApp(debugShowCheckedModeBanner: false, home: WebviewPage()));
...
class _WebviewPageState extends State<WebviewPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: WebView(
        initialUrl: 'https://ts7.x1.arabics.travian.com/',
